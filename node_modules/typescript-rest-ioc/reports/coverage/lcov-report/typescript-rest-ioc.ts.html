...
<head>
    <title>Code coverage report for typescript-rest-ioc.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> typescript-rest-ioc.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Container } from 'typescript-ioc';
...
&nbsp;
    getTargetClass: (serviceClass: Function) =&gt; {
        ...
        while (typeConstructor) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeConstructor['name'] &amp;&amp; typeConstructor['name'] !== 'ioc_wrapper') {
                return typeConstructor as FunctionConstructor;
            }
<span class="cstat-no" title="statement not covered" >            typeConstructor = typeConstructor['__parent'];</span>
        }
        ...
        throw new TypeError('Can not identify the base Type for requested target');
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu Feb 27 2020 14:22:44 GMT-0300 (Brasilia Standard Time)
            </div>
        </div>
